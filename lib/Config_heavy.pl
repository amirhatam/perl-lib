...
cf_time='Sat Aug 10 12:45:29 2024'
charbits='8'
chgrp=''
chmod=''
chown=''
...
mydomain=''
myhostname=''
myuname='Win32 strawberry-perl 5.40.0.1 # 02:45:15 Sat August 10 2024 x64'
n='-n'
need_va_copy='undef'
netdb_hlen_type='int'
...
ccflags_nolargefiles='-std=c99 -DWIN32 -DWIN64 -DPERL_TEXTMODE_SCRIPTS -DMULTIPLICITY -DPERL_IMPLICIT_SYS -DUSE_PERLIO -D__USE_MINGW_ANSI_STDIO -fwrapv -fno-strict-aliasing -mms-bitfields'
ldflags_nolargefiles='-s -L"C:\STRAWB~1\perl\lib\CORE" -L"C:\STRAWB~1\c\lib" -L"C:\STRAWB~1\c\x86_64-w64-mingw32\lib" -L"C:\STRAWB~1\c\lib\gcc\x86_64-w64-mingw32\13.2.0"'
